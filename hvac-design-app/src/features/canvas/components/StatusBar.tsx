...
export function StatusBar({ mousePosition, className = '' }: StatusBarProps): React.ReactElement {
  const zoom = useZoom();
  ...
  return (
    ...
    >
      ...
      {/* Center section: Grid and snap info */}
      <div className="flex items-center gap-4">
        {/* Grid snap indicator */}
        <div
      ...
      {/* Right section: Selection count and zoom */}
      <div className="flex items-center gap-4">
        {/* Selection count */}
        {selectionCount > 0 && (
