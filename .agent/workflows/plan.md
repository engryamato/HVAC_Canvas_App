...
- Output: PLAN-{task-slug}.md in the project root (dynamic naming)
...
3. Create PLAN-{slug}.md in the project root with task breakdown
...
|-------------|----------|
| Project Plan | `PLAN-{task-slug}.md` |
